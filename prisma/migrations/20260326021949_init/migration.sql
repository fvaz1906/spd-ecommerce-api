...
-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('PENDING', 'AUTHORIZED', 'PAID', 'REFUSED', 'REFUNDED', 'CANCELLED');

-- CreateEnum
CREATE TYPE "PaymentMethod" AS ENUM ('PIX', 'CREDIT_CARD', 'DEBIT_CARD', 'BOLETO');

-- CreateEnum
CREATE TYPE "ShipmentStatus" AS ENUM ('PENDING', 'READY_FOR_DISPATCH', 'IN_TRANSIT', 'DELIVERED', 'RETURNED', 'CANCELLED');
...
CREATE TABLE "Shipment" (
    ...
    "freightPriceInCents" INTEGER NOT NULL,
